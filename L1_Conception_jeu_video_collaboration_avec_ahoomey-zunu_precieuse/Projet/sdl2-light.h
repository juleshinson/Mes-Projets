...
/**
 * \brief Libère la mémoire associée à la musique
 * \param music la musique à libérer
*/

void clean_music(Mix_Music *music);

/**
 * \brief Libère la mémoire associée à un effet sonore
 * \param chunk l'effet sonore à libérer
*/

void clean_chunk(Mix_Chunk *chunk);
